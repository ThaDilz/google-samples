...
public class ScoresV1 {
	 ...
	 * invalid, the client ID included in the token is not in the list of allowed
	 * clientIds, or the audience included in the token is not in the list of
	 * allowed audiences.
	 * @throws IOException
	 */
	...
	public List<Score> list(
		...
		PersistenceManager pm = PMF.PM.getPersistenceManager();

 ...
 */
CLIENT_ID =
    '1030661332744-ugftr186nb8i41ddatgfbtn11tusqab3.apps.googleusercontent.com';
...
signinCallback = function(authResult) {
  var tokenEmail = getEmailFromIDToken(
      authResult.id_token);
		
  if (authResult.access_token && tokenEmail) {
    init('//' + window.location.host + '/_ah/api', tokenEmail);
//    init('https://2-dot-vivid-lambda-561.appspot.com/_ah/api', tokenEmail);

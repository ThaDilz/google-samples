...
constants.CLIENT_ID = '787488693961.apps.googleusercontent.com';

constants.ACH_KILL_ENEMY = 'CgkIyb3vz_UWEAIQAQ';
constants.ACH_PRECISION1 = 'CgkIyb3vz_UWEAIQAg';
constants.ACH_PRECISION2 = 'CgkIyb3vz_UWEAIQAw';
constants.ACH_PRECISION3 = 'CgkIyb3vz_UWEAIQBA';
constants.ACH_PRECISION4 = 'CgkIyb3vz_UWEAIQBQ';
constants.ACH_INTEGRITY1 = 'CgkIyb3vz_UWEAIQBg';
constants.ACH_INTEGRITY2 = 'CgkIyb3vz_UWEAIQBw';
constants.ACH_INTEGRITY3 = 'CgkIyb3vz_UWEAIQCA';
constants.ACH_INTEGRITY4 = 'CgkIyb3vz_UWEAIQCQ';
constants.ACH_RANK1 = 'CgkIyb3vz_UWEAIQCg';
constants.ACH_RANK2 = 'CgkIyb3vz_UWEAIQCw';
constants.ACH_RANK3 = 'CgkIyb3vz_UWEAIQDA';
constants.ACH_RANK4 = 'CgkIyb3vz_UWEAIQDQ';
constants.ACH_RANK5 = 'CgkIyb3vz_UWEAIQDg';
constants.ACH_RANK6 = 'CgkIyb3vz_UWEAIQDw';
constants.ACH_EXPERIENCE1 = 'CgkIyb3vz_UWEAIQEA';
constants.ACH_EXPERIENCE2 = 'CgkIyb3vz_UWEAIQEQ';
constants.ACH_EXPERIENCE3 = 'CgkIyb3vz_UWEAIQEg';
constants.ACH_EXPERIENCE4 = 'CgkIyb3vz_UWEAIQEw';
constants.ACH_FREQUENT = 'CgkIyb3vz_UWEAIQFA';
constants.ACH_SERIOUS = 'CgkIyb3vz_UWEAIQFQ';
constants.ACH_OVUM = 'CgkIyb3vz_UWEAIQFg';

constants.LEAD_ONE = 'CgkIyb3vz_UWEAIQFw';

constants.ACHIEVEMENTS = {
  KILL_ENEMY: constants.ACH_KILL_ENEMY,
  PRECISION: [
    {kills: 5, id: constants.ACH_PRECISION1},
    {kills: 10, id: constants.ACH_PRECISION2},
    {kills: 25, id: constants.ACH_PRECISION3},
    {kills: 50, id: constants.ACH_PRECISION4}
  ],
  INTEGRITY: [
    {time: 30, id: constants.ACH_INTEGRITY1},
    {time: 60, id: constants.ACH_INTEGRITY2},
    {time: 120, id: constants.ACH_INTEGRITY3},
    {time: 300, id: constants.ACH_INTEGRITY4}
  ],
  RANK: [
    {score: 1000, id: constants.ACH_RANK1},
    {score: 2000, id: constants.ACH_RANK2},
    {score: 3000, id: constants.ACH_RANK3},
    {score: 5000, id: constants.ACH_RANK4},
    {score: 8000, id: constants.ACH_RANK5},
    {score: 15000, id: constants.ACH_RANK6}
  ],
  EXPERIENCE: [
    {kills: 50, id: constants.ACH_EXPERIENCE1},
    {kills: 100, id: constants.ACH_EXPERIENCE2},
    {kills: 200, id: constants.ACH_EXPERIENCE3},
    {kills: 500, id: constants.ACH_EXPERIENCE4}
  ],
  FREQUENT: constants.ACH_FREQUENT,
  SERIOUS: {minScore: 2000, id: constants.ACH_SERIOUS},
  OVUM: constants.ACH_OVUM
};
